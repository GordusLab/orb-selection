...
TD_LO_TO_BLASTP_DIR=${TD_LO_TO_BLASTP_DIR:-PATH_TO_TD_LO_TO_BLASTP_DIR}
BLASTP_OUT_DIR=${BLASTP_OUT_DIR:-PATH_TO_BLASTP_OUTPUT_DIR}
UNIPROT_DB=${UNIPROT_DB:-PATH_TO_UNIPROT_SPROT_FASTA}
TD_P_RUN_DIR=${TD_P_RUN_DIR:-PATH_TO_TD_P_RUN_DIR}
