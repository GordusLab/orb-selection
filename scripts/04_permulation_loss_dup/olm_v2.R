...
# Progress file setup
progress_file <- "/scratch4/agordus1/crunnel2/phyloglm_progress.txt"
...
# Combine temp files into final CSVs
combine_tmp_results(tmp_loss_dir, here("results/phyloglm_loss.csv"))
