...
INPUT_DIR=${INPUT_DIR:-PATH_TO_TD_LO_OUTPUT_DIR}
CD_HIT_FASTA_DIR=${CD_HIT_FASTA_DIR:-PATH_TO_CD_HIT_FASTA_DIR}
BLASTP_DIR=${BLASTP_DIR:-PATH_TO_BLASTP_OUTPUT_DIR}
TD_P_COMPLETE_DIR=${TD_P_COMPLETE_DIR:-PATH_TO_TD_P_COMPLETE_DIR}
