...
from src.hyphy_results_parser import HyphyResultsManager
...
```python
from src.hyphy_results_helpers import filter_omega, omega_filter_summary
...
from src.hyphy_results_parser import HyphyResultsManager
from src.hyphy_results_helpers import convert_hyphy_results_to_locs, filter_omega
...
Test with real data (update paths in the script):

```bash
cd orb-selection/tests  
python hyphy_parser_example.py
```
