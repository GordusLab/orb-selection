...
- `scripts/04_selection_tests/hyphy_results_parser.py` - Main module with result classes
- `scripts/04_selection_tests/hyphy_results_helpers.py` - Helper functions
- `tests/test_hyphy_module.py` - Test script with sample data
- `scripts/04_selection_tests/parse_hyphy_results.py` - Project parser workflow script
- `scripts/04_selection_tests/README_hyphy_module.md` - This documentation
...
```bash
cd orb-selection/scripts/04_selection_tests
