#!/bin/bash
#SBATCH --job-name=260512_phyloglm_pvals_test_1-10
...
Rscript /home/crunnel2/orb-selection/scripts/04_permulation_loss_dup/empirical_pvals_with_qvalues.R ${SLURM_NTASKS}
