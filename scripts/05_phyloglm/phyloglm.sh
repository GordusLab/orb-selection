#!/bin/bash
#SBATCH --job-name=260722_phyloglm
...
#SBATCH --mail-user=crunnel2@jh.edu
...
cd /home/crunnel2/orb-selection

Rscript /home/crunnel2/orb-selection/scripts/05_phyloglm/phyloglm.R