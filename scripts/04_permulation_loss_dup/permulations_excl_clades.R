...
source(here("scripts/04_permulation_loss_dup/permulations.R"))
...
testCatPerms <- run_categorical_permulations(
        ...
        ntrees = 10000,
        save_rdata_path = here("data/perms10000_no_ara.RData"),
        excluded_tips = c(
...
save_tip_values(testCatPerms, here("data/perms_tip_values_no_ara.csv"))
...
testCatPerms <- run_categorical_permulations(
        foreground_list_filename = here("data/orbweavers-list.txt"),
        ntrees = 10000,
        save_rdata_path = here("data/perms10000_no_tet.RData"),
        excluded_tips = c(
            "Drosophila_melanogaster",
            "Antrodiaetus_roretzi",
            "Orchestina_okitsui",
...
save_tip_values(testCatPerms, here("data/perms_tip_values_no_tet.csv"))
